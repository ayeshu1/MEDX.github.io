           ...
           <div class="col-md-6">
              ...
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th> Dealer ID</th><th> Dealer Name</th><th>Dealer Contact No.</th>
                    </tr></thead>
                    <tbody>
                      <?php 
                        $result1=mysqli_query($con,"select * from dealer")or die ("query 1 incorrect.....");
                        
                        while(list($dealer_id,$dealer_name,$dealer_contact)=mysqli_fetch_array($result1))
                        { 
                            


                        echo "<tr><td>$dealer_id</td><td>$dealer_name</td><td>$dealer_contact</td>
