	...
	<a class=" btn btn-primary" href="addproduct.php">Add New</a></th></tr></thead>
                    <tbody>
                      <?php 
                        ...
                        // $result=mysqli_query($con,"select * from product_id,product_image, product_title,product_price from products  where  product_cat=1 or product_cat=3 or product_cat=4 Limit $page1,12")or die ("query 1 incorrect.....");
...
$result=mysqli_query($con,"select  product_id,product_image, product_title,product_price from products Limit $page1,12")or die ("query 1 incorrect.....");
                        ...
                        <td>$price</td>
                        <td>
<a href='productlist.php?product_id=$product_id&action=delete' type='button' rel='tooltip' title='' class='btn btn-success btn-md' data-original-title='Delete'>
